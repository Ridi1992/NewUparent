...
public class Me extends Activity implements OnClickListener,OnPhotoPickedlistener {
	...
	private void setinfo(Teacherinfo data) {
		...
		case R.id.logoff:
			...
			view.findViewById(R.id.ok).setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					((MyApplication) getApplication()).setAlias("0");
					finish();
	        ...
	        public void run() {
	            ...
	            try {
	        		...
	        		if (jsonObj.getString("success").equals("true")) {
	    				...
	    				Object  object=JsonUtil.instance().fromJson(jsonData, new TypeToken<Teacherinfo>(){}.getType());
