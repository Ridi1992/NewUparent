...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((MyApplication) getApplication()).setAlias(Userinfo.getmobile_phone(MainActivity.this));
...
//					startActivity(intent);
				...
				case 14://关于我们
					...
					break;
				case 15://群聊
					ArrayList<Groups> groups=mUserInfo.GetTeacherinfo(MainActivity.this).getGroups();
					if(groups!=null&&groups.size()>0){
						intent.setClass(getApplicationContext(), ChatActivity.class);
						intent.putExtra("userId", groups.get(0).getGroupId());
						intent.putExtra("chatType", Constant.CHATTYPE_GROUP);
						startActivity(intent);
					}else{
						Toast.makeText(getApplicationContext(), "没有群信息", 0).show();
					}
