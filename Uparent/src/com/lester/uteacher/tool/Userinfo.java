...
import com.lester.uparent.login.parentInfo;
...
public class Userinfo {
	...
	public static void setinfo(Activity a, parentInfo data){
	...
	public static void setchildinfo(Activity a, Childdatas datas) {
